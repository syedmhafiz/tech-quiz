...
function Quizzes() {
  ...
  return (
    <div className='flex justify-center'>
      <div className='w-[1250px] h-[75vh] bg-secondary text-white'>
        <div className='p-12'>
          <h1 className='font-bold text-2xl my-4 text-accent'>Select the correct answers from below...</h1>
          ...
          <div className='grid grid-cols-2 grid-row-2 gap-x-24 gap-y-12 p-10 text-xl'>
            <button onClick={checkCorrectAns} id='1' className=''>
              <div className='h-[80px] border-2 rounded-xl w-[500px] p-2 bg-white text-dark-blue text-center hover:bg-light-green'>
          ...
          <div className='flex justify-between align-middle p-8 mt-6'>
            ...
            }
            {
              ...
              <button type="button" onClick={nextQ} class="text-blue-700 border border-white
                ...
                dark:text-white dark:hover:text-dark-blue dark:focus:ring-blue-800 dark:hover:bg-light-green">
            ...
            {
              endQ &&
              <button type="button" onClick={submitAnswer} class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium 
                rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700
